...
\begin{enumerate}
    \item \textbf{Average Daily Cases in Year \( y \) and Province \( \ell \):}
    ...
    \[
    \text{Estimated Annual Cases}_{y\ell} = D_y \times \left( \frac{\sum_{t \in {\mathcal T}_y} c_{t\ell}}{\sum_{t \in {\mathcal T}_y} d_{t\ell}} \right)
    \]
    ...
    \[
    \text{Total Estimated Cases}_{yr} = D_y \times \sum_{\ell \in {\mathcal L}_r} \left( \frac{\sum_{t \in {\mathcal T}_y} c_{t\ell}}{\sum_{t \in {\mathcal T}_y} d_{t\ell}} \right)
    \]
    ...
    \[
    \text{Incidence Rate}_{yr} = 100,000 \times D_y \times \frac{\sum_{\ell \in {\mathcal L}_r} \left( \frac{\sum_{t \in {\mathcal T}_y} c_{t\ell}}{\sum_{i \in {\mathcal T}_y} d_{t\ell}} \right)}{\sum_{\ell \in {\mathcal L}_r} p_{y\ell}}
    \]
\end{enumerate}
