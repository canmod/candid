...
\begin{enumerate}
    ...
    \item \textbf{Estimated Total Annual Cases in year \( y \) in Province \( \ell \):}
    ...
    Sum the estimated annual cases over all provinces and territories \( \ell \) within region \( r \):
